        ...
        <div class="container">
            <div class="left">
                ...
                <ul class="formas-de-contato">
                    <li>
                        <div class="icone">
                            <img src="<?php echo get_template_directory_uri() ?>/assets/ph_phone-duotone.svg" alt="">
                        </div>
                    ...
                    <li>
                        <div class="icone">
                            <img src="<?php echo get_template_directory_uri() ?>/assets/ant-design_mail-twotone.svg" alt="">
                        </div>
                        <div class="informacao">
                            <h4>E-mail:</h4>
                    ...
                    <li>
                        <div class="icone">
                            <img src="<?php echo get_template_directory_uri() ?>/assets/ph_clock-duotone.svg" alt="">
                        </div>
                        <div class="informacao">
