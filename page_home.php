...
<?php get_header(); ?>
    ...
    <?php if (get_field('acf_exibir_sessao_sobre_nos')) : ?>
    ...
    <?php if (get_field('acf_exibir_sessao_especialidade')) : ?>
    ...
    <?php if (get_field('acf_exibir_sessao_de_noticias')) : ?>
    ...
    <?php if (get_field('acf_exibir_sessao_de_corpo_clinico')) : ?>
    ...
    <?php if (get_field('acf_exibir_sessao_de_videos_em_destaque')) : ?>
