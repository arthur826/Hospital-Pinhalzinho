...
<div class="card-videos-destaque">
    <a href="">
      ...
      <h3>AHBP capacita rede credenciada sobre qualidade do atendimento</h3>
      <p>
        O período deverá ser marcado pela modernização dos serviços prestados,
    ...
    <div class="container">
      <div class="top">
        <div class="endereco-e-contato">
            ...
            <a href="" class="links-do-footer">Av. Belo Horizonte, 2200 | Centro</a>
            <a href="" class="links-do-footer">Pinhalzinho/SC - 89870-000</a>
        </div>
        <div class="links-institucionais">
          <h4>Institucional</h4>
          <a href="" class="links-do-footer">Institucional</a>
          <a href="" class="links-do-footer">Corpo Clínico</a>
          <a href="" class="links-do-footer">Especialidades</a>
          <a href="" class="links-do-footer">Vídeos</a>
          <a href="" class="links-do-footer">Convênios</a>
        </div>
        <div class="links-uteis">
          <h4>Links úteis</h4>
          <a href="" class="links-do-footer">Fale Conosco</a>
          <a href="" class="links-do-footer">Horários de Visita</a>
          <a href="" class="links-do-footer">Convênios</a>
          <a href="" class="links-do-footer">Política de Privacidade</a>
        </div>
